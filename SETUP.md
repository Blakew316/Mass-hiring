...
| I want a flyer / PDF sent with every email | Email Template → **Attachments** → *Add file* (PNG, JPG, GIF, WebP or PDF, up to 4 MB each, three files). The Account Executive flyer is already there; click × to remove it. Attachments show in the preview and the send dialog. |
